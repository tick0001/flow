...
Le projet en est au jalon J7 sur onze : les bots s'exécutent dans un worker séparé, se lancent
depuis l'interface, par expression cron ou par clé d'API, s'interrompent, se regardent travailler en
direct, leurs échecs se diagnostiquent à l'écran, et l'écran de pilotage dit ce qui casse le plus
souvent et depuis quand. La [feuille de route](docs/06-feuille-de-route.md) dit ce qui
vient ensuite.
