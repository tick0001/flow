...
async function bootstrap(): Promise<void> {
  ...
  // `credentials` : sans lui le navigateur n'envoie pas le cookie de session, et
  // toute requete authentifiee echoue en developpement -- ou l'interface vit sur
  // un autre port -- sans erreur explicite.
