...
import { createDatabase, type Connection, type Database } from '@flow/db';
  ...
  providers: [
    {
      ...
      useFactory: (): Connections => {
        ...
        return {
          ...
          // qu'a l'amorcage, a l'authentification et a la sonde de sante. Lui
          // donner de la place prendrait des connexions au trafic reel.
