 ...
 *
 * Ordre de priorité : préférence explicite du compte, puis en-tête du navigateur,
 * puis la langue par défaut. Les étiquettes régionales (`fr-CA`) sont ramenées à
 * leur langue de base plutôt que rejetées — sans quoi un navigateur canadien
 * verrait l'anglais alors que le français est disponible.
 */
