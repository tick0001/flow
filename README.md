...
A **plugin** extends the application: it gets its own PostgreSQL schema, declares its rights,
hooks into bot launches, subscribes to events, fills interface slots, adds background tasks — and
